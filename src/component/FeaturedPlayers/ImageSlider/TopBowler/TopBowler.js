    ...
    <div className={Styles.container}>
      ...
      >
        <SwiperSlide className={`swiper-slide ${Styles.swiper_slide}`}>
          {/* <img loading='lazy' src={slide_image_1} alt="slide_image" />  */}
          <img loading='lazy' src="https://ik.imagekit.io/acjcnxcdk/extractedimages/DaleSteyn.png?updatedAt=1714733230429" alt="slide_image" className={Styles.img}/>

        </SwiperSlide>
        <SwiperSlide className={`swiper-slide ${Styles.swiper_slide}`}>
          {/* <img loading='lazy' src={slide_image_2} alt="slide_image" /> */}
          <img loading='lazy' src="https://ik.imagekit.io/acjcnxcdk/extractedimages/BreetLee.jpg?updatedAt=1714733229953" alt="slide_image" className={Styles.img} />

        </SwiperSlide>
        <SwiperSlide className={Styles.swiper_slide}>
          {/* <img loading='lazy' src={slide_image_3} alt="slide_image" /> */}
          <img loading='lazy' src="https://ik.imagekit.io/acjcnxcdk/extractedimages/JamesAnderson.png?updatedAt=1714733230288" alt="slide_image" className={Styles.img}/>

        </SwiperSlide>
        <SwiperSlide className={Styles.swiper_slide}>
          {/* <img loading='lazy' src={slide_image_4} alt="slide_image" /> */}
          <img loading='lazy' src="https://ik.imagekit.io/acjcnxcdk/extractedimages/JaspritBumrah.jpg?updatedAt=1714733233377" alt="slide_image" className={Styles.img}/>

        </SwiperSlide>
        <SwiperSlide className={Styles.swiper_slide}>
          {/* <img loading='lazy' src={slide_image_5} alt="slide_image" /> */}
          <img loading='lazy' src="https://ik.imagekit.io/acjcnxcdk/extractedimages/LasithMalinga.png?updatedAt=1714733233507" alt="slide_image" className={Styles.img} />

        </SwiperSlide>
        <SwiperSlide className={Styles.swiper_slide}>
          {/* <img loading='lazy' src={slide_image_6} alt="slide_image" /> */}
          <img loading='lazy' src="https://ik.imagekit.io/acjcnxcdk/extractedimages/ShoaibAkhtar.png?updatedAt=1714733236330" alt="slide_image" className={Styles.img}/>

        </SwiperSlide>
        <SwiperSlide className={Styles.swiper_slide}>
          {/* <img loading='lazy' src={slide_image_7} alt="slide_image" /> */}
          <img loading='lazy' src="https://ik.imagekit.io/acjcnxcdk/extractedimages/TrentBoult.jpg?updatedAt=1714733236427" alt="slide_image" className={Styles.img}/>
